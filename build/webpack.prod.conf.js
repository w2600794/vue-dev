...
const webpackConfig = merge(baseWebpackConfig, {
    ...
    output: {
        ...
        chunkFilename: utils.assetsPath('static/js/app/[id].[chunkhash].js')
    },
    plugins: [
        ...
        // }),
        // new HtmlWebpackPlugin({
        //     filename: config.build.problems,
        //     template: './src/pages/problems/problems.html',
        //     inject: true,
        //     minify: {
        //         removeComments: true,
        //         collapseWhitespace: true,
        ...
        //     // necessary to consistently work with multiple chunks via CommonsChunkPlugin
        //     chunksSortMode: 'dependency',
        //     chunks: ['manifest', 'vendor', 'problems'],
        // }),
